            ...
            <div class="container">
                <div class="row">
                  ...
                  <h2 style="margin-top: -100px;"> Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria; font-size: 30px;">Private Cloud Access Request </h2><br>
                    ...
                    <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from reqreg where type='Private Cloud' and statua='Waiting' ");
                        ...
                        <td style='font-weight: bold;'><a href='req2.jsp?sno=<%=rs.getString("sno")%>&&mail=<%=rs.getString("mail_id")%>&&name=<%=rs.getString("name")%>&&id=<%=rs.getString("id")%>' style='color:Green;'>Send Key</a></td>
