        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="row">
                  ...
                  <h2 style="margin-top: -100px; color: whitesmoke;">Supporting Authorized Duplicate Check in a Hybrid Cloud Architecture</h2><br><br>
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria; font-size: 30px;">Private Cloud File Access Request</h2><br>
             <table>
                    <tr>
                        ...
                        <td style='color:navy; font-weight: bold;'>Cloud Type</td>
                        ...
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/secureiot","root","");
                        PreparedStatement query=con.prepareStatement("select * from Request where status='waiting' and type='Private Cloud' ");
                        ...
                        <td style='font-weight: bold;'><a href='Key_File1.jsp?sno=<%=rs.getString("sno")%>&&name=<%=rs.getString("name")%>&&oname=<%=rs.getString("oname")%>&&reg=<%=rs.getString("reg")%>&&trap=<%=rs.getString("trap")%>&&id=<%=rs.getString("id")%>&&image=<%=rs.getString("image")%>' style='color:Green;'>Send Key</a></td>
