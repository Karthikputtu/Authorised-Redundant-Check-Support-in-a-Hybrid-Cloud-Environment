        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="row">
                  ...
                  <h2 style="margin-top: -100px;"> Scalable Secure Big Data IOT System</h2><br><br>
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria; font-size: 30px;">Public Cloud File Access Request </h2><br>
             <table>
                    <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from Request where status='waiting' and type='Public Cloud' ");
