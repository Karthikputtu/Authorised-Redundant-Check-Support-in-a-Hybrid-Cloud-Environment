        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mainNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="Public_Home.jsp">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="pubclient.jsp">Public Client</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="pubfiles.jsp">Public Files</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="Result.jsp">Result</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    h3{
                      ...
                      <h2 style="color: white; text-shadow: 0px 5px 6px white;  margin-left: 50px;font-family: cambria;font-weight: bold; font-size: 30px;">Public Cloud Clients</h2><br>
                    <style>
                ...
                <table align="center">
                    <tr>
                        ...
                        PreparedStatement query=con.prepareStatement("select * from upload where type='Public Cloud'");
